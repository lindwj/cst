...
public class SdVoucher implements Serializable{	
	...
	/** 借方数量 */
	private java.lang.Integer dqty;
	/** 贷方数量 */
	private java.lang.Integer cqty;
	/** 结算方式编码 */
	 ...
	 * @param acctId
	 */
	public void setAcctId(java.lang.Integer acctId) {
		this.acctId = acctId;
	}
	/**
	 * 科目编码
	 * @return
	 */
	public java.lang.Integer getAcctId() {
		return this.acctId;
	}
	/**
	 * 设置 币种编码
	 ...
	 * @param dqty
	 */
	public void setDqty(java.lang.Integer dqty) {
		this.dqty = dqty;
	}
	/**
	 * 借方数量
	 * @return
	 */
	public java.lang.Integer getDqty() {
		return this.dqty;
	}
	/**
	 * 设置 贷方数量
	 * @param cqty
	 */
	public void setCqty(java.lang.Integer cqty) {
		this.cqty = cqty;
	}
	/**
	 * 贷方数量
	 * @return
	 */
	public java.lang.Integer getCqty() {
		return this.cqty;
	}
	/**
	 * 设置 结算方式编码
