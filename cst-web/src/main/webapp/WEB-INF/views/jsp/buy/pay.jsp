            ...
            <div id="item-list">
                ...
                <div class="item clearfix">
                    <div class="itemInfo item-title">
                        ...
                        <a href="<%=path%>/resource/electricBusiness/productDetail.html?productUuid=${orders.productUuid}" class="itemInfo-link">
                            <span class="item-pic"><span>
                                <img class="itemInfo-pic" src="${orders.pic}">
                            </span>
                            </span>
                            <span class="itemInfo-title">${orders.subject}</span>
                        </a>
                    </div>
                    <div class="item-type">
                    ...
                    <div class="item-price">
                        <span class="price"><em id="showprice">${orders.price}</em></span>
                    </div>
        ...
        <div class="order-go">
            <div class="address-confirm clearfix">
                ...
                <div class="submitOrder">
					...
					<input type="hidden" name="subject" value="${orders.subject}" />
