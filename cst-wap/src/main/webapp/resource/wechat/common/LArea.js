...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.locate = document.querySelector(params.locate);
        ...
        finish: function(e) {
                    ...
                    function(data){
                		if(data.length>0){
                			...
                			$.each(data,function(i,item){
                				street_val+="<option value='"+item.id+"'>"+item.street+"</option>";
                			})
                			$(_self.street).append(street_val);
                		}else{
                			$(".add_street").hide();
                		}
                    },
            ...
            this.locate.value= provinceVal +' ' + cityVal + ' ' + countyVal;
            _self.close(e);
        },
        close: function(e) {
            e.preventDefault();
