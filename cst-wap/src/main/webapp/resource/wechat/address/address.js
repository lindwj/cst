...
$(function(){
    ...
    $(".addnew").click(function(){
    	if(orders!=null&&orders!=""&&orders!=undefined&&shop!=1){
    		window.location.href = addressDetail_path + '?' +orders;
    	}else if(shop==1){
    		window.location.href = addressDetail_path + '?' +orders + '?1';
    	}else{
    		window.location.href = addressDetail_path;
    	}
    })
    ...
    function getOrderList(info) {
        ...
        $(".edit").click(function(){
            ...
            if(orders!=null&&orders!=""&&orders!=undefined&&shop!=1){
            	window.location.href = addressDetail_path + '?' +orders + '?addressUuid=' + pid;
            }else if(shop==1){
            	window.location.href = addressDetail_path + '?' +orders + '?addressUuid=' + pid + '?1';
            }else{
            	window.location.href = addressDetail_path + '?addressUuid=' + pid;
            }
        });

        $(".arrow").click(function(){
        	if(orders!=null&&orders!=""&&orders!=undefined&&shop!=1){
    			window.location.href = orderBuy_url + '?' +orders;
    		}else if(shop==1){
    			window.location.href = selt_path + '?' +orders;
    		}else{
