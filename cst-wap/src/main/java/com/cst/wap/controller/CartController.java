...
public class CartController {
	...
	/** 保存新增对象 */
	@RequestMapping("/cartSaveWx.do")
	@ResponseBody
	public int cartSaveWx(Cart cart, HttpServletRequest request, HttpServletResponse response) throws Exception {
		// 校验空值
	...
	/** 删除对象 */
	@RequestMapping("/cartDeleteAllWx.do")
	@ResponseBody
	public int cartDeleteAll(Cart cart, HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	/** 删除对象 */
	@RequestMapping("/cartDeleteWx.do")
	@ResponseBody
	public int cartDelete(Cart cart, HttpServletRequest request, HttpServletResponse response) throws Exception {
		// 校验空值
		if (cart.getProductUuid() == null || cart.getProductUuid().length() <= 0) {
			return 0;
		}
